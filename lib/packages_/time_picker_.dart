...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  // TextStyle defaultSeparatorTextStyle = const TextStyle(fontSize: 32, color: Colors.black54);
  ...
  String? _getSeparator() {
    return widget.separator ?? defaultSeparator;
  }
  ...
  Widget spacer() {
    return SizedBox(
        width: (widget.spacing == 0) ? null : _getSpacing(),
        height: _getItemHeight()! * 3,
        child: Center(
          child: FittedBox(
            child: Text(
  ...
  Widget am_pm_spacer() {
    return SizedBox(
      width: _getSpacing(),
      height: _getItemHeight()! * 3,
      // child: (widget.separator != null) ? Text(widget.separator!) : null,
    );
  }
